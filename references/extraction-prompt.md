...
信息不足时保留局部观察或输出空数组，绝不编造伏笔回收、情绪评分、词性统计、全书频次或未出现的人物对白。明确区分叙述者、内心活动、说出口的话、引述文本。将“人物声称”“当前视角相信”“本片段确证”分开；留意对话中的反驳、诱导和信息差。记录角色面对谁、要达成什么，别把某一场景的长短句或沉默固定成全书口吻。章首复现引句、广告与梗概不算新的独立文学证据；疑似缺字或排版污染应限制句法判断。
